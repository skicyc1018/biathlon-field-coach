...
window.BFCCreateTemplateBoard = createTemplateBoard;
...
function init(){
  ...
  document.addEventListener('click',e=>{
    const tpl=e.target.closest && e.target.closest('[data-action=\"template-board\"], #directBoardBtn, #templateBoardBtn');
    if(tpl){ e.preventDefault(); createTemplateBoard(); return; }
